...
void Fire2012WithPalette()
{
  ...
  for ( int j = 0; j < NUM_LEDS; j++) {
    ...
    CRGB color;
    switch (fireMode) {
      case 0: color = ColorFromPalette( gPal1, colorindex);
        break;
      case 1: color = ColorFromPalette( gPal2, colorindex);
        break;
      case 2: color = ColorFromPalette( gPal3, colorindex);
        break;
      case 3: color = ColorFromPalette( gPal4, colorindex);
        break;
    }
